...
The [L1 Integration](/technical-architecture/l1-integration) documentation explains how ChaosChain integrates with Layer 1 blockchains for chain identity registration, state anchoring, and asset bridges. The [Chain Registry Contract](/technical-architecture/l1-integration/registry-contract) serves as the authoritative source of truth for chain identification.
...
- [API Specifications](/developer-resources/api)
- [Node Configuration](/developer-resources/node-configuration)
- [Agent Integration Guide](/developer-resources/agent-integration) 