...
For detailed information on each modification area, visit the [Node](/technical-architecture/node) section.

### [Separation of Identity](/technical-architecture/node-modifications/identity-module)
