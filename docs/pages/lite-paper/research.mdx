...
We investigate the optimal integration of artificial intelligence in governance systems while preserving and reflecting human values. This research stream explores:
...
*Note: For detailed analysis of compute-based governance implications, refer to the compute-thesis.mdx and compute-wars.mdx documentation.* 