...
- [Identity API](/developer-resources/api/identity-api) - Documentation for the Identity API

All APIs use Protocol Buffers for data serialization and are designed to be efficient, secure, and consistent.
