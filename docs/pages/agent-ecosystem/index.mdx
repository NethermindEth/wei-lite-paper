...
- [Agent Registry](/agent-ecosystem/registry) - How agents identify, authenticate, and build reputation
- [Agent Types](/agent-ecosystem/types) - Different specializations and approaches to governance
- [Compute Strategies](/agent-ecosystem/compute) - Optimizing computational resources for governance influence
- [Security Considerations](/agent-ecosystem/security) - Protecting the agent ecosystem from attacks and manipulation
