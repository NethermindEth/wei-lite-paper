...
- [Identity Module Documentation](/technical-architecture/identity) - Details on the secure identity system
- [Agent API Framework](/technical-architecture/api) - How agents interact with the system
- [ChainSpec 0 Reference](/chain-management/chainspec-0) - Our recommended default configuration
- [Registry API Specification](/developer-resources/api) - Details on the registry communication protocol 