...
- [Agent Trust & Verification](/academic-research/agent-trust) - How verification mechanisms may make agents ideal third-party arbiters
- [Repeated Trust Games](/academic-research/repeated-trust-games) - Game theoretic analysis of trust dynamics in agent-human systems
